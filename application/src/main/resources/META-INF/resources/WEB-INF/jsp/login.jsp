...
<header class="d-flex justify-content-between align-items-center p-2" style="border-bottom: 3px solid #3496f9;max-width: 1500px; margin: 0 auto;">
    	...
    	<div>
    		<a href="http://localhost:8080/signup">
    			<button class="btn" type="button" style="background: #3496f9; color: #ffffff">Sign up</button>
    		</a>
    	</div>
    </header>
    	...
    	<div style="max-width: 1200px; margin: 0 auto;">
    		<!-- Hero Section -->
    			...
    			<div class="col-md-6 m-auto d-flex justify-content-end">
    				<form method="post" action="http://localhost:8080/customer/authenticate-login" class="justify-self-end" style="background-color: #153c64;padding: 1.5em 2em 3em;border-radius: 20px;width: 80%;">
