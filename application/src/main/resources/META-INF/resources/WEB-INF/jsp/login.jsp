...
<html xmlns:th="https://www.thymeleaf.org" lang="en">
  ...
  <!-- Header -->
    <header class="d-flex justify-content-between align-items-center p-4" style="border-bottom: 2px solid #222222;max-width: 1500px; margin: 0 auto;">
    	...
    	<div>
    		<a href="http://localhost:8080/signup">
    			<button class="btn" type="button" style="border: 2px solid #222222">Sign up</button>
    		</a>
    	</div>
    </header>
    ...
    <main style="height: 80vh;">
    	<!-- Main Page Content -->
    	<div class="h-100" style="max-width: 1200px; margin: 0 auto;">
    		<!-- Hero Section -->
    		<section class="w-100 h-100 grid justify-content-center gap-2 my-5 px-4" style="padding-top: 4rem;color: #222222;">
    			<!-- Row -->
    			...
    			<div class="col-md-6 m-auto d-flex justify-content-end">
    				<form method="post" action="http://localhost:8080/customer/authenticate-login" class="justify-self-end" style="background-color: #222222;padding: 1.5em 2em 3em;border-radius: 20px;width: 80%;">
    				<p class="text-center" style="color: #ffffff; font-weight: 600;font-size: 1.2rem;">Login</p>
    				<!-- Form Error -->
			        ...
			        <div class="mb-2">
			          <label for="exampleInputPassword1" class="form-label" style="color: #ffffff">Password</label>
			          <input
			            type="password"
			            class="form-control"
			        ...
			        <button class="btn py-2 mt-4" type="submit" style="width: 100%; background: #ffffff; color: #000000">Submit</button>
			      </form>
    			</div>
    			</div>
    		</section>
